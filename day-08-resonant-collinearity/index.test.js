...
describe('countAntinodes', () => {
  it('should return 2 for a pair of same freq antennas', () => {
    const antennasMap = [
      [
        '.', '.', '.', '.',
        '.', '.', '.', '.',
    ...
    const antinodesCount = countAntinodes(antennasMap);
    expect(antinodesCount).toBe(2);
  });
  it('should correctly count provided example', () => {
    const antennasMap = [
      [
        '.', '.', '.', '.',
        '.', '.', '.', '.',
    ...
    const antinodesCount = countAntinodes(antennasMap);
    expect(antinodesCount).toBe(14);
  });
  it('should correctly count provided example - harmonic', () => {
    const antennasMap = [
      [
        '.', '.', '.', '.',
        '.', '.', '.', '.',
    ...
    const antinodesCount = countAntinodes(antennasMap, true);
    expect(antinodesCount).toBe(34);
  })
});
